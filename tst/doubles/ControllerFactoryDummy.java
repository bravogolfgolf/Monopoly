...
public class ControllerFactoryDummy extends ControllerFactory {
    ...
    public ControllerFactoryDummy(Presenter presenter, VersionFactory factory, InteractorFactory interactorFactory, Players players, Console console) {
        super(presenter, factory, interactorFactory, players, console);
    }
