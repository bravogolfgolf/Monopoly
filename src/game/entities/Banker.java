...
import game.interactors.luxurytax.CollectLuxuryTaxBanker;
...
public class Banker implements PaySalaryBankerGateway, CollectIncomeTaxBankerGateway, CollectLuxuryTaxBanker {
    ...
    public void collectLuxuryTax() {
        currentPlayer.transaction(75, PAY_CASH);
    }
}
